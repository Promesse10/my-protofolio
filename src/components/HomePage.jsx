...
import {
  ...
  FaReact, FaFigma, FaPaintBrush, FaHtml5,  
  FaDownload,
  FaGithub,
  FaDribbble,
  FaMoon,
...
export default function Portfolio() {
  ...
  const sendEmail = (templateParams) => {
    return emailjs.send("service_f04qg4p", "template_ne6rzch", templateParams, "yjDmZVG90i3oxo4s5")
  }
  ...
  const StatusDot = ({ status }) => {
    ...
    return (
      <motion.div
        ...
        animate={{
          boxShadow: [
            `0 0 0 0 ${status === "online" ? "rgba(34, 197, 94, 0.4)" : "rgba(249, 115, 22, 0.4)"}`,
            `0 0 0 10px ${status === "online" ? "rgba(34, 197, 94, 0)" : "rgba(249, 115, 22, 0)"}`,
          ],
        }}
        transition={{
  ...
  <p>
    I am a passionate UI/UX Designer and Front-End Developer with over 3 years of experience. 
    Skilled in Figma, Photoshop, I create intuitive designs for websites and mobile apps. 
    As a front-end developer, I specialize in React.js, React Native, HTML5, CSS3, and JavaScript to bring designs to life and deliver seamless user experiences.
  </p>
    ...
    about: {
      ...
      content: (
        <div className="space-y-6">
          ...
          Frontend Developer & UI/UX Designer with a passion for creating intuitive and engaging digital experiences. Skilled in Figma for designing seamless user interfaces and React for building dynamic web applications. Successfully improved user engagement by 40% across multiple projects, including Karkelly, where I contributed both in Figma and coding. Led design and frontend development initiatives that resulted in a 70% increase in conversions and usability scores. Passionate about crafting world-class applications with a focus on user-centric design and performance.
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              <SkillBar skill="React, React Native" percentage={84} isDarkMode={isDarkMode} />
              <SkillBar skill="Three.js" percentage={50} isDarkMode={isDarkMode} />
          ...
          <div className="space-y-4 mt-6">
            ...
            <ul className="space-y-2">
              <li>
                ...
                <p className={`${isDarkMode ? "text-gray-300" : "text-gray-950"}`}>University of KIgali, 2024</p>
              </li>
          ...
          <div className="space-y-4 mt-6">
            ...
            <p className={`${isDarkMode ? "text-gray-300" : "text-gray-950"}`}>
            Experienced Front-End Engineer with a strong background in enhancing web application performance and user experience. Skilled in HTML, CSS, JavaScript, and React, with a track record of improving website load times, user retention, and accessibility. Adept at UI/UX design, usability testing, and responsive web development, ensuring seamless integration of design and functionality. Passionate about delivering efficient, scalable, and user-friendly digital solutions.
            </p>
          </div>
          <a
  href="/Correct CV.pdf"
...
>
  ...
  {projects
    ...
    .map((project, index) => (
      <div key={index} className="relative group w-full h-64 rounded-lg overflow-hidden shadow-lg">
        {/* Project Image */}
        ...
        <div className="absolute bottom-0 left-0 w-full h-0 bg-black bg-opacity-60 opacity-0 group-hover:h-16 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center">
          <a href={project.link} target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-white text-black rounded-lg shadow-md hover:bg-gray-200">
            View Project
          </a>
        </div>
      </div>
          ...
          >
            <div className="relative h-full">
              ...
              <div className="absolute inset-0">
                <img src={image} alt="Profile" className="object-cover w-ful  h-full" />
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 z-10 ">
                ...
                <div className="flex gap-6">
                  {[
                    { icon: FaFacebookF, url: "https://www.facebook.com/IPLOFTE" },
      
                    { icon: FaLinkedinIn, url: "https://rw.linkedin.com/in/irakoze-promesse-422700217" },
